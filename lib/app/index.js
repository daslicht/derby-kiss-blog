...
get('/', function(page, model, params){
    model.subscribe('myapp.blogs.blog', function(err, blog) {

        /*model.setNull('myapp.blogs.blog', [
...
ready(function(model) {
    ...
    exports.newHeadline = function (e, el, next) {
        ...
        var newItem = {name: 'Kitty', score: 2000};

        model.push( 'myapp.blogs.blog', newItem, function(data){
       ...
       // var arr = model.filter('blogs').get()

        //console.log('myarray:', model.filter('blogs').get());
   //
     //model.ref( "_blogs", arr )
